...
META: dict[str, tuple] = {
    ...
    # --- historical English -----------------------------------------------
    "en/WYCLIFFE BIBLE": (1395, VUL, "formal", "Lollard / pre-Reformation", "Translated from the Vulgate, not the Hebrew or Greek - so it shows which Latin-derived readings reached English before the source texts did. Complete (66 books plus 10 deuterocanonical, including the Epistle to the Laodiceans)."),
    ...
    "en/ROTHERHAM EMPHASISED BIBLE": (1902, CRIT, "formal", "Restoration movement", "Rotherham's Emphasised Bible. Transliterates Sheol and Hades rather than flattening both to 'hell', and marks emphasis typographically."),
    "en/LEESER OLD TESTAMENT 1853": (1853, MT, "formal", "Jewish", "The first Jewish translation of the Hebrew Bible into English, 64 years before the JPS. Reads 'this young woman' at Isaiah 7:14."),
    "en/NOYES TRANSLATION 1869": (1869, CRIT, "formal", "Unitarian", "George Noyes' translation. Reads 'the damsel' at Isaiah 7:14 - 77 years before the RSV was accused of inventing that reading."),
    "en/DARBY BIBLE 1890": (1890, CRIT, "formal", "Plymouth Brethren", "John Nelson Darby's translation. Darby also originated the pre-tribulational rapture scheme; his rendering of 1 Thessalonians 4:17 is worth reading against that."),
    "en/BIBLE IN BASIC ENGLISH": (1949, CRIT, "dynamic", "Protestant (British)", "Restricted to a controlled ~1,000-word vocabulary, which forces interpretive choices into the open."),
    "en/KJV CAMBRIDGE PARAGRAPH BIBLE 1873": (1873, TR, "formal", "Protestant (Church of England)", "Scrivener's critical edition of the KJV text, correcting printing-history corruptions. Useful as a control on what the KJV actually said."),
    "en/TARGUM ONKELOS (ETHERIDGE)": (1862, "Aramaic Targum", "formal", "Jewish (Targumic)", "Etheridge's English of Targum Onkelos, the authoritative Aramaic paraphrase of the Pentateuch (c. 2nd c. CE). An independent ancient witness to how Jewish readers understood the Hebrew - it renders Genesis 3:15 'He will remember thee'. WARNING: Exodus is offset by one verse (Hebrew numbering) - Targum Exodus 22:17 is the KJV's 22:18. Genesis is aligned."),
    "en/TEXT-CRITICAL ENGLISH NEW TESTAMENT": (2022, BYZ, "formal", "Byzantine priority", "Robert Adam Boyd. CC BY 4.0. Byzantine base with text-critical apparatus."),
    "en/FAMILY 35 NEW TESTAMENT": (2016, "Family 35", "formal", "Byzantine priority", "Wilbur Pickering. CC BY-SA 4.0. Follows the Family 35 manuscript line; omits the Comma Johanneum."),
